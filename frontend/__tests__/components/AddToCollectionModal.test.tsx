...
import { render, fireEvent, screen, cleanup } from '@testing-library/react';
// components under test
import Collection from 'src/views/Project/AddToCollectionModal/Collection';
import AddToCollectionView from 'src/views/Project/AddToCollectionModal/AddToCollectionView';
import CreateCollectionView from 'src/views/Project/AddToCollectionModal/CreateCollectionView';
